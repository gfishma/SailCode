...
#include "std_spi.h"
extern spi_dev_class wizchip_spi;
...
uint8_t wizchip_spi_readbyte(void)
{
	...
	spi_bus_read(wizchip_spi.bus, 1, &pData);
//	spi_dev_read(&wizchip_spi, 1, &pData);
	return pData;
};
...
{
	spi_bus_write(wizchip_spi.bus, 1, &wb);
//	spi_dev_write(&wizchip_spi, 1, &wb);
};
